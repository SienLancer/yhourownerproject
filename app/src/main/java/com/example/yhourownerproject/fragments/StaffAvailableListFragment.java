 ...
 * Use the {@link StaffAvailableListFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class StaffAvailableListFragment extends Fragment {
    View mView;
    ...
    public StaffAvailableListFragment() {
        // Required empty public constructor
    }


    public static StaffAvailableListFragment newInstance(String param1, String param2) {
        StaffAvailableListFragment fragment = new StaffAvailableListFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_staff_available_list, container, false);
                                                                                            ...
                                                                                            for (DataSnapshot userSnapshot : usersSnapshot.getChildren()) {
                                                                                                ...
                                                                                                if (userRole != null && userRole == 1) {
                                                                                                    ...
                                                                                                    if (shopData.exists()) {
                                                                                                        ...
                                                                                                        if (shopIdCheck != null && shopIdCheck.equals(staffShopId) && available != null && available == 1) {
